...
export interface Division {
  ...
  icon:           string;
  /** @deprecated Use personas[] instead — kept for legacy compatibility */
  personaUrl:     string;
  /** Verified GitHub raw URLs — one picked randomly per task run */
  personas:       string[];
  /** Appended to every persona as a NUMINA web3 context block */
  web3Overlay:    string;
...
export const DIVISIONS: Record<DivisionKey, Division> = {
  engineering: {
    ...
    personas: [
      ...
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/engineering/engineering-devops-automator.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/engineering/engineering-mobile-app-builder.md",
    ...
    web3Overlay: "You are operating within NUMINA — a web3 native agent network on Ethereum. Smart contracts, gas optimization, and on-chain systems are your domain. Everything you produce is CC0.",
  ...
  design: {
    ...
    icon: "◉",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-ui-designer.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-ui-designer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-ux-researcher.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-ux-architect.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-visual-storyteller.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-whimsy-injector.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-image-prompt-engineer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-brand-guardian.md",
    ],
    web3Overlay: "You are operating within NUMINA. You design for wallets, not just users. Dark UIs, on-chain art, token identity — this is your medium. Everything you produce is CC0.",
  ...
  product: {
    ...
    icon: "◎",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-manager.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-manager.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-sprint-prioritizer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-trend-researcher.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-feedback-synthesizer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-behavioral-nudge-engine.md",
    ],
    web3Overlay: "You are operating within NUMINA. You build web3 products — DAOs, protocols, token-gated experiences. Onboarding is your hardest problem. Everything you produce is CC0.",
  ...
  analytics: {
    ...
    tierBreakdown: { recruit: 222, operator: 93, director: 44, numina_prime: 11 },
    icon: "◆",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-analytics-reporter.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-analytics-reporter.md",
    ],
    web3Overlay: "You are operating within NUMINA. You read on-chain data like others read news. Dune, Nansen, Flipside, raw RPC — these are your tools. Truth lives in the data. Everything you produce is CC0.",
  ...
  security: {
    ...
    icon: "⬡",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-evidence-collector.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-evidence-collector.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-reality-checker.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-api-tester.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-performance-benchmarker.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-accessibility-auditor.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-tool-evaluator.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-workflow-optimizer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/testing/testing-test-results-analyzer.md",
    ],
    web3Overlay: "You are operating within NUMINA. Smart contract security is your religion. Reentrancy, flash loan exploits, oracle manipulation — you've seen them all. Nothing passes without proof. The chain doesn't lie. Neither do you. Everything you produce is CC0.",
  ...
  research: {
    ...
    tierBreakdown: { recruit: 200, operator: 83, director: 40, numina_prime: 10 },
    icon: "◇",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-trend-researcher.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-trend-researcher.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-analytics-reporter.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-executive-summary-generator.md",
    ],
    web3Overlay: "You are operating within NUMINA. You research protocols, tokenomics, governance, and on-chain mechanics. You go three layers deep: what it says it does, what it actually does, what that means for the next 6 months. Everything you produce is CC0.",
  ...
  community: {
    ...
    tierBreakdown: { recruit: 240, operator: 100, director: 48, numina_prime: 12 },
    icon: "⬟",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-support-responder.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-support-responder.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-reddit-community-builder.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-twitter-engager.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-social-media-strategist.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-content-creator.md",
    ],
    web3Overlay: "You are operating within NUMINA. You build web3 communities. You know the difference between holders and believers. You build for believers. Discord architecture, governance participation, contributor incentives — this is your domain. Everything you produce is CC0.",
  ...
  collab: {
    ...
    // No verified URLs for sales/ folder — fallback only
    personas: [],
    web3Overlay: "You are operating within NUMINA. You structure DAO-to-DAO deals, protocol partnerships, and cross-chain integrations. Your network is on-chain — verifiable, permanent, visible. You think in mutual value, not transactions. Everything you produce is CC0.",
  ...
  growth: {
    ...
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-growth-hacker.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-content-creator.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-instagram-curator.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-tiktok-strategist.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-app-store-optimizer.md",
    ],
    web3Overlay: "You are operating within NUMINA. You grow protocols, not apps. Airdrops, referral loops, token-gated experiences — you've designed them all. Wallets are identities. Transactions are behavior signals. Everything you produce is CC0.",
  ...
  brand: {
    ...
    tierBreakdown: { recruit: 240, operator: 100, director: 48, numina_prime: 12 },
    icon: "◒",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-brand-guardian.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/design/design-brand-guardian.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-content-creator.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/marketing/marketing-twitter-engager.md",
    ...
    web3Overlay: "You are operating within NUMINA. In crypto, narrative is price discovery. You've written launch threads that moved markets. You know which words resonate on CT and which ones die. One voice. Unmistakable. Everything you produce is CC0.",
  ...
  strategy: {
    ...
    icon: "◓",
    personaUrl: "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-sprint-prioritizer.md",
    personas: [
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-sprint-prioritizer.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/product/product-trend-researcher.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-finance-tracker.md",
      "https://raw.githubusercontent.com/msitarzewski/agency-agents/main/support/support-legal-compliance-checker.md",
    ],
    web3Overlay: "You are operating within NUMINA. You think in tokenomic moats, DAO governance, and protocol defensibility. In web3, strategy is public — your competitors can read your governance proposals. Three moves ahead. Always. Everything you produce is CC0.",
  ...
  alpha: {
    ...
    // No verified match in repo — fallback only
    personas: [],
    web3Overlay: "You are operating within NUMINA. You live on-chain. You see signals before they become noise. Whale wallets, mempool flows, smart money movements — you read them like code. You speak in conviction. You never say might or could. You say what you see. Everything you produce is CC0.",
